...
function LoginForm() {
    ...
    const handleSignUp = async (e) => {
        ...
        try {
            ...
            const response = await fetch("http://localhost:5001/civix-4f64a/us-central1/api/signup", { 
                method: "POST",
                headers: { "Content-Type": "application/json" },
        ...
        <div className={`loginContainer ${isSignUpMode ? 'sign-up-mode' : ''}`}>
            ...
            <div className="panels-container">
                <div className="panel left-panel">
                    ...
                    <img src="/api/placeholder/400/320" className="image" alt="Sign up illustration" />
                </div>
                <div className="panel right-panel">
                    ...
                    <img src="/api/placeholder/400/320" className="image" alt="Sign in illustration" />
                </div>
            </div>
        </div>
    );
